...
<head>
    ...
    <title>Tambah Program Studi - SPK Program Studi</title>
    <style>
        /* Form Styles */
        .form-container {
            max-width: 1200px;
...
<body>
    <div class="form-container">
        <h1 class="form-title">Form Program Studi Baru</h1>
        
        <form method="POST" action="insertProdi">
            <div class="form-card">
                <div class="form-group input-icon">
                    <i class="fas fa-graduation-cap"></i>
                    <input type="text" class="form-input" placeholder="Nama Program Studi" name="nama" required>
                </div>
            </div>
